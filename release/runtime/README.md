...
Use `python monitor_codex_usage.py --dashboard` to open the dashboard automatically. The server listens on `http://127.0.0.1:8765`; install the matching VSIX from the parent release directory to connect VS Code to it.
